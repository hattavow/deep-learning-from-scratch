...
class SimpleConvNet:
    def __init__(
        ...
        # 2x2 Stride 2のMax poolingのため、出力サイズはconv_output_sizeの半分になる。
        # 本来の計算式
        # pool_output_h = (conv_output_size - pool_h) // stride + 1
        # pool_output_w = (conv_output_size - pool_w) // stride + 1
